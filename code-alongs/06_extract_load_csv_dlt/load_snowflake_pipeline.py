...
if __name__ == "__main__":
    ...
    # specify the pipline name, destination and dataset name when configuring pipline,
    ...
    # print the data yeilded from resource
    print(data)

    # run the pipline with your parameters
    load_info = pipline.run(data, table_name = "netflix")
